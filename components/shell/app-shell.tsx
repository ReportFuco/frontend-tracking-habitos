  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex w-full max-w-[1400px]">
        <aside
          className={cn(
            "fixed inset-y-0 left-0 z-40 w-72 shrink-0 bg-[color:var(--sidebar)] transition-transform duration-200 md:sticky md:top-0 md:z-10 md:h-screen md:translate-x-0",
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <Topbar profile={profile} onMenu={() => setOpen(true)} variant={variant} />
